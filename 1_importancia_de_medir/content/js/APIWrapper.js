...
/*******************************************************************************/
/* Function isEmpty sirve para comprobar si un objeto es vacío, y así poder controlar errores de acceso
a propiedades de objetos que estén vacíos*/
...
function getAPI()
{
   ...
   if (theAPI == null)
   {
      if(_Debug==true) alert("Unable to find an API adapter");
   }
   return theAPI
}
